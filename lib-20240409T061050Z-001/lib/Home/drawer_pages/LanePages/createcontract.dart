...
class _CreateColloborationState extends State<CreateColloboration> {
  ...
  final CreateContractFirebaseService _firebaseService = CreateContractFirebaseService();
 ...
 Future<void> _search() async {
  ...
  Future<void> _searchByDomain(String domain) async {
    Map<String, dynamic> result = await _firebaseService.getUsersByDomain(_allUsers, domain);
    ...
    setState(() {
      ...
      _auth_ids = filteredUsers.map((user) => user['Auth_id'].toString()).toList();
    });
  }

  Future<void> _searchByVillage(String village) async {
    Map<String, dynamic> result = await _firebaseService.getUsersByVillage(_allUsers, village);
    List<Map<String, dynamic>> filteredUsers = result['users'];
  ...
  Future<void> _searchByDomainAndVillage(String domain, String village) async {
    Map<String, dynamic> mapUsers =
        await _firebaseService.getUsersByDomainAndVillage(_allUsers, domain, village);
                          ...
                          TextButton(
                            onPressed: () {
                              setState(() {
                                ...
                                people++;
                                String Auth_id =_auth_ids[_users.indexOf(itemSelectedMember)];
                                toBeCreatedContractingPeoples.add(Auth_id);
                                MemberSelectedOpt.add([itemSelecteddomain, itemSelectedVillage, itemSelectedMember]);
                                userDetailsPopview.add(currentUserDetailsDisplay);
                                ...
                                itemSelectedMember = ''; itemSelectedVillage = ''; itemSelecteddomain='';
  ...
  Future<UserDetails> SelectedMemberDetails(String Auth_id) async{
      ...
      UserDetails ud = UserDetails(authId: data['Auth_id'], name: data['Name'], domain: data['Domain'], location: data['Location'], phoneno: data['Phone'].toString(), address: data['Village'], profile: profile);
      return ud;
  }
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: DropdownSearch<String>(
                          ...
                          selectedItem: MemberSelectedOpt.length>i ? MemberSelectedOpt[i][0] : itemSelecteddomain,
                        ),
                      ),
                      SizedBox(
                        width: 40,
                      ...
                      // Expanded(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: DropdownSearch<String>(
                                        ...
                                        selectedItem: MemberSelectedOpt.length>i ? MemberSelectedOpt[i][1] : itemSelectedVillage ,
                                      ),
                                    ),
                                    Container(
                                      width: 300,
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: DropdownSearch<String>(
                                      ...
                                      onChanged: (value) async{
                                        String Auth_id =_auth_ids[_users.indexOf(value.toString())];
                                        UserDetails ud = await SelectedMemberDetails(Auth_id);
                                        setState(() {
                                      ...
                                      selectedItem:  MemberSelectedOpt.length>i ? MemberSelectedOpt[i][2] :  itemSelectedMember,
                                    ),
                                  ),
                                ],
                              ),
                        ...
                        Expanded(
                          child: Container(
                            // color: Colors.pink,
                            width: 300,
                            height: infoWindowVisible==true || userDetailsPopview.length>i ? 280 : 0,
                            child: userDetailsPopview.length>i ? popView(userDetailsPopview[i]): infoWindowVisible==true ? popView(currentUserDetailsDisplay) : Container()
                          ),
                        )
